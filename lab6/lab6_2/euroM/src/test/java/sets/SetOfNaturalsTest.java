...
public class SetOfNaturalsTest {
    ...
    // Check that an IllegalArgumentException is raised when trying to add a duplicate value
    @Test
    public void testAddDuplicate() {
        assertThrows(IllegalArgumentException.class, () -> setB.add(10));
    }

    // Check that an IllegalArgumentException is raised when trying to add an array that has duplicates
    @Test
